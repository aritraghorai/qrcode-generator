        ...
        {Qrcode && (
          <>
            ...
            <a
              href={Qrcode}
              download="qrcode.png "
              className="ml-5 border-2 border-gray-300 rounded-md p-2 font-bold bg-red-500 text-white hover:bg-transparent hover:border-green-500 hover:text-black hover:border-1"
            >
              Download
            </a>
          </>
